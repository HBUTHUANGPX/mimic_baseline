...
def ref_human_anchor_rot6d_in_sim_anchor(
...
def sim_robot_body_pos_in_sim_anchor(
    env: ManagerBasedEnv, command_name: str
) -> torch.Tensor:
    command: MotionCommand = env.command_manager.get_term(command_name)
...
def sim_robot_body_rot6d_in_sim_anchor(
    env: ManagerBasedEnv, command_name: str
) -> torch.Tensor:
    command: MotionCommand = env.command_manager.get_term(command_name)
...
def ref_robot_anchor_pos_in_sim_anchor(
    env: ManagerBasedEnv, command_name: str
) -> torch.Tensor:
    command: MotionCommand = env.command_manager.get_term(command_name)
...
def ref_robot_anchor_rot6d_in_sim_anchor(
    env: ManagerBasedEnv, command_name: str
) -> torch.Tensor:
    command: MotionCommand = env.command_manager.get_term(command_name)
...
def ref_robot_minus_sim_joint_angle_rad(
    env: ManagerBasedEnv, command_name: str
) -> torch.Tensor:
    command: MotionCommand = env.command_manager.get_term(command_name)
...
def actor_ref_robot_fsq_feature_window(
    env: ManagerBasedEnv, command_name: str
) -> torch.Tensor:
    command: MotionCommand = env.command_manager.get_term(command_name)
...
def actor_ref_human_fsq_feature_window(
    env: ManagerBasedEnv, command_name: str
) -> torch.Tensor:
    command: MotionCommand = env.command_manager.get_term(command_name)
...
def critic_ref_robot_fsq_feature_window(
    env: ManagerBasedEnv, command_name: str
) -> torch.Tensor:
    command: MotionCommand = env.command_manager.get_term(command_name)
...
def critic_ref_human_fsq_feature_window(
    env: ManagerBasedEnv, command_name: str
) -> torch.Tensor:
    command: MotionCommand = env.command_manager.get_term(command_name)
