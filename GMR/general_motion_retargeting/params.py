...
IK_CONFIG_DICT = {
    ...
    "xsens_bvh_online":{
        "unitree_g1": IK_CONFIG_ROOT / "xsens_bvh_online_to_g1.json",
        "unitree_h1_2": IK_CONFIG_ROOT / "xsens_bvh_online_to_h1_2.json",
        "Q1": IK_CONFIG_ROOT / "xsens_bvh_online_to_Q1.json",
    },
    "fbx":{
