...
*/
const std::vector<quaternionKinematics>& QuaternionDatagram::getData() const
{
    // std::cout << "DEBUG: QuaternionDatagram::getData() called, m_data.size() = " << m_data.size() << std::endl;
    return m_data;
}
