...
class pin_mj:
    def __init__(self, _URDF_PATH=""):
        ...
        self.robot: RobotWrapper = RobotWrapper.BuildFromURDF(
            URDF_PATH, cfg.asset_path, pin.JointModelFreeFlyer()
        )
...
class cfg:
    ...
    policy_path = (
        current_path
        + "/"
        + "deploy_mujoco/deploy_policy/g1/2026-02-26_15-36-49_G1_slowly_walk"
        + "/policy.onnx"
    )
    asset_path = current_path + "/deploy_mujoco/assets/unitree_g1"
    mjcf_path = asset_path + "/g1_29dof_rev_1_0.xml"
    urdf_path = asset_path + "/g1_29dof_mode_15.urdf"
    motion_file = (
        current_path
        + "/deploy_mujoco/artifacts/g1/"
